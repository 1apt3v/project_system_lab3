...
namespace Tyuiu.IstominNM.Lab3.Review.V2
{
    internal class Program
    {
        ...
        static void Option5() // четвёртый пункт меню
        {
            ...
            Console.WriteLine("");
            Console.WriteLine(string.Format("Минимальный элемент: {0} ", ds.CalculateMinimum(array)));
            Console.WriteLine(string.Format("Максимальный элемент: {0} ", ds.CalculateMaximum(array)));
            Console.WriteLine(string.Format("Среднее: {0} ", ds.CalculateAverage(array)));
        ...
        static void OptionFS() // выбор справки в главном меню
        {
            ...
            Console.WriteLine(" Программу разработал Истомин Никита Максимович | НТм-23-1 | ТИУ 2024");
            Console.SetCursorPosition(0,22);
            Console.WriteLine("_______________________________________________________");
        ...
        static void drawMainMenu() // Рисуем главное меню
        {
            ...
            Console.WriteLine("|        Выполнил Истомин Никита Максимович           |");
